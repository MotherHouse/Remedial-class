                    ...
                    <div class="col-lg-6">
                        ...
                        <form class="form-horizontal" id="rehe-form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="stu_id" class="form-control" id="inputname"  value="<?php echo ($score["stu_id"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="tea_id" id="inputPassword3"  value="<?php echo ($score["tea_id"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="class_name" id="inputPassword3"  value="<?php echo ($score["class_name"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="score" id="inputPassword3"  value="<?php echo ($score["score"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="score_remark" id="inputPassword3"  value="<?php echo ($score["score_remark"]); ?>">
                                </div>
                            </div>
