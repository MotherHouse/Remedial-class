                            ...
                            <div class="content table-responsive table-full-width">
                                ...
                                <table class="table table-hover table-striped singcms-table">
                                    ...
                                    <?php if(is_array($menus)): $i = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menus): $mod = ($i % 2 );++$i;?><tr>
                                            <td>
                                                <input size="2" type="text" name="listorder[<?php echo ($menus["menu_id"]); ?>]" value="<?php echo ($menus["listorder"]); ?>"/>
                                            </td>
                                            <td><?php echo ($menus["menu_id"]); ?></td>
                                            <td><?php echo ($menus["name"]); ?></td>
                                            <td><?php echo ($menus["c"]); ?></td>
                                            <td><?php echo ($menus["f"]); ?></td>
                                            <td><?php echo (getMenuStatus($menus["status"])); ?></td>
                                            <td>
                                                <span class="pe-7s-note" id="rehe-edit" attr-id="<?php echo ($menus["menu_id"]); ?>" onclick="edit()"></span>
                                                <span class="pe-7s-close-circle" id="rehe-delete" attr-id="<?php echo ($menus["menu_id"]); ?>" attr-message="删除"></span>
                                            </td>
...
<script>
    var SCOPE = {
        'skip_url' : 'admin.php?c=menu&a=add',
