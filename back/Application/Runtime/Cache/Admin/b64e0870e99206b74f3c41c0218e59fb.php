                    ...
                    <div class="col-lg-6">
                        ...
                        <form class="form-horizontal" id="rehe-form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="tea_name" class="form-control" id="inputname"  value="<?php echo ($teacher["tea_name"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="tea_gender" class="form-control" id="inputname"  value="<?php echo ($teacher["tea_gender"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="tea_age" class="form-control" id="inputname"  value="<?php echo ($teacher["tea_age"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <img style="" id="upload_org_code_img" src="<?php echo ($teacher["tea_photo_url"]); ?>" width="150" height="150">
                                    <input id="file_upload_image" name="tea_photo_url" type="hidden" multiple="true" value="<?php echo ($teacher["tea_photo_url"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <textarea  rows = "5" class="form-control" name="self_introduction" id="inputPassword3" value=""><?php echo ($teacher["self_introduction"]); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="tea_tel" id="inputPassword3"  value="<?php echo ($teacher["tea_tel"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="pwd" id="inputPassword3"  value="<?php echo ($teacher["pwd"]); ?>">
                                </div>
                            </div>
                            ...
                            <input type="hidden" name="tea_id"  value="<?php echo ($teacher["tea_id"]); ?>">
                        </form>
