...
<div class="content">
    <div class="container-fluid">
        <div class="typo-line">
            <p class="category"><?php echo ($tea["tea_name"]); ?></p>
            <blockquote>
                <p>
                    <?php echo ($tea["self_introduction"]); ?>
                </p>
        ...
        <div class="typo-line">
            <p class="category"><?php echo ($class["grade"]); ?>-<?php echo ($class["subject"]); ?>-<?php echo ($class["tea_id"]); ?></p>
            <blockquote>
                <p>
                    <br /><br />
                    <?php echo ($class["class_introduction"]); ?>
                </p>
