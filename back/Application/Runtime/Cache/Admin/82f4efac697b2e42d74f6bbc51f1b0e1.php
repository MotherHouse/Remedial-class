                    ...
                    <div class="col-lg-6">
                        ...
                        <form class="form-horizontal" id="rehe-form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="tea_name" class="form-control" id="inputname" placeholder="请填写老师姓名" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5" style="margin-top:5px">
                                    <input type="radio" name="tea_gender" id="optionsRadiosInline1" value="男" checked> 男
                                    <input style="margin-left: 15px" type="radio" name="tea_gender" id="optionsRadiosInline2" value="女"> 女
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" name="tea_age" class="form-control" id="inputname" placeholder="请填写老师年龄" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    ...
                                    <img style="display: none" id="upload_org_code_img" src="<?php echo ($teacher["tea_photo_url"]); ?>" width="150" height="150">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <textarea  rows = "5" class="form-control" name="self_introduction" id="inputPassword3" placeholder="请填写自我介绍"></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="tea_tel" id="inputPassword3" placeholder="请填写联系方式"/>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" class="form-control" name="pwd" id="inputPassword3" placeholder="请填写密码">
                                </div>
                            </div>
