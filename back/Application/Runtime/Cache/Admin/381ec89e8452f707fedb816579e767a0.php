                    ...
                    <div class="col-lg-6">
                        ...
                        <form class="form-horizontal" id="rehe-form">
                            <div class="form-group">
                                <label for="inputname" class="col-sm-2 control-label">学生:</label>
                                <div class="col-sm-5">
                                    <input type="text" name="stu_id" class="form-control" id="inputname" placeholder="请填写老师单名" value="<?php echo ($comment["stu_id"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="tea_id" id="inputPassword3" placeholder="老师照片地址" value="<?php echo ($comment["tea_id"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="class_id" id="inputPassword3" placeholder="方法名如index" value="<?php echo ($comment["class_id"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="stars" id="inputPassword3"  value="<?php echo ($comment["stars"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <textarea  rows = "5" class="form-control" name="content" value=""><?php echo ($comment["content"]); ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="comment_time" id="inputPassword3" placeholder="方法名如index" value="<?php echo ($comment["comment_time"]); ?>">
                                </div>
                            </div>
...
<script>
    var SCOPE = {
        ...
        'success_url' : 'admin.php?c=comment',
    }
</script>
