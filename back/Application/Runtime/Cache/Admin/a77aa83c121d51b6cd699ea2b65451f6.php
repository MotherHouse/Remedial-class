                        ...
                        <form class="form-horizontal" id="rehe-form">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5" style="margin-top:5px">
                                    <input type="radio" name="status" id="optionsRadiosInline1" value="1" <?php if($menus["status"] == 1): ?>checked<?php endif; ?>> 开启
                                    <input type="radio" name="status" id="optionsRadiosInline2" value="0" <?php if($menus["status"] == 0): ?>checked<?php endif; ?>> 关闭
                                </div>
                            </div>
