                    ...
                    <div class="col-lg-6">
                        ...
                        <form class="form-horizontal" id="rehe-form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="stu_name" class="form-control" id="inputname" placeholder="请填写学生姓名" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="stu_age" id="inputPassword3" placeholder="请填写年龄">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="stu_grade" id="inputPassword3" placeholder="请填写年级">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <img style="display: none" id="upload_org_code_img"  width="150" height="150">
                                    <input id="file_upload_image" name="stu_photo_url" type="hidden" multiple="true" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="stu_gender" id="inputPassword3" placeholder="请填写性别">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="stu_tel" id="inputPassword3" placeholder="请填写电话">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="stu_register_date" id="inputPassword3" placeholder="请填写注册时间">
                                </div>
                            </div>
