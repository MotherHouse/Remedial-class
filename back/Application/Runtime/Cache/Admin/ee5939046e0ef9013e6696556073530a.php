                    ...
                    <div class="col-lg-6">
                        ...
                        <form class="form-horizontal" id="rehe-form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" name="stu_name" class="form-control" id="inputname" placeholder="请填写老师单名" value="<?php echo ($student["stu_grade"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="stu_age" id="inputPassword3" placeholder="老师照片地址" value="<?php echo ($student["stu_age"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="stu_grade" id="inputPassword3" placeholder="方法名如index" value="<?php echo ($student["stu_grade"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <img style="" id="upload_org_code_img" src="<?php echo ($student["stu_photo_url"]); ?>" width="150" height="150">
                                    <input id="file_upload_image" name="stu_photo_url" type="hidden" multiple="true" value="<?php echo ($student["stu_photo_url"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="stu_gender" id="inputPassword3" placeholder="方法名如index" value="<?php echo ($student["stu_gender"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="stu_tel" id="inputPassword3" placeholder="方法名如index" value="<?php echo ($student["stu_tel"]); ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" name="stu_register_date" id="inputPassword3" placeholder="方法名如index" value="<?php echo ($student["stu_register_date"]); ?>">
                                </div>
                            </div>
...
<script>
    var SCOPE = {
        'add_url' : 'admin.php?c=student&a=add',
        'success_url' : 'admin.php?c=student',
