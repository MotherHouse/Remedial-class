                            ...
                            <div class="content table-responsive table-full-width">
                                ...
                                <table class="table table-hover table-striped singcms-table">
                                    ...
                                    <?php if(is_array($student)): $i = 0; $__LIST__ = $student;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$student): $mod = ($i % 2 );++$i;?><tr>
                                            <td>
                                                <input size="2" type="text" name="listorder[<?php echo ($student["stu_id"]); ?>]" value="<?php echo ($student["listorder"]); ?>"/>
                                            </td>
                                            ...
                                            <td><?php echo ($student["stu_tel"]); ?></td>
                                            <td><?php echo ($student["stu_register_date"]); ?></td>
                                            <td><a href="<?php echo ($student["stu_photo_url"]); ?>">点我查看</a></td>
                                            <td>
                                                <span class="pe-7s-note" id="rehe-edit" attr-id="<?php echo ($student["stu_id"]); ?>"></span>
                                                <span class="pe-7s-close-circle" id="rehe-delete" attr-id="<?php echo ($student["stu_id"]); ?>" attr-message="删除"></span>
                                            </td>
...
<script>
    var SCOPE = {
        'skip_url' : 'admin.php?c=student&a=add',
        'edit_url' :'admin.php?c=student&a=edit',
        'set_status_url' : 'admin.php?c=student&a=setStatus',
        'listorder_url' : 'admin.php?c=student&a=listorder'
    }
</script>
