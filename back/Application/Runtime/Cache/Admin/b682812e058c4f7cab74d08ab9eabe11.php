                            ...
                            <div class="content table-responsive table-full-width">
                                <form id="singcms-listorder">
                                    <table class="table table-hover table-striped singcms-table">
                                        ...
                                        <tbody>
                                        <?php if(is_array($teacher)): $i = 0; $__LIST__ = $teacher;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$teacher): $mod = ($i % 2 );++$i;?><tr>
                                                <td>
                                                    <input size="2" type="text" name="listorder[<?php echo ($teacher["tea_id"]); ?>]" value="<?php echo ($teacher["listorder"]); ?>"/>
                                                </td>
                                                <td><?php echo ($teacher["tea_id"]); ?></td>
                                                <td><?php echo ($teacher["tea_name"]); ?></td>
                                                <td><?php echo ($teacher["tea_gender"]); ?></td>
                                                <td><?php echo ($teacher["tea_age"]); ?></td>
                                                <td>
                                                    <a href="<?php echo ($teacher["tea_photo_url"]); ?>">
                                                        点我查看
                                                    </a>
                                                </td>
                                                <td>
                                                    <a id="rehe-detail"  attr-teaid="<?php echo ($teacher["tea_id"]); ?>">
                                                        点我查看
                                                    </a>
                                                </td>
                                                <td><?php echo ($teacher["tea_tel"]); ?></td>
                                                <td><span attr-type="<?php if($teacher['status'] == 1): ?>2<?php else: ?>1<?php endif; ?>"
                                                    attr-id="<?php echo ($teacher["tea_id"]); ?>" class="sing_cursor singcms-on-off" id="singcms-on-off">
                                                    <?php echo (getStatus($teacher["status"])); ?>
                                                </span></td>
                                                <td>
                                                    <span class="pe-7s-note" id="rehe-edit" attr-id="<?php echo ($teacher["tea_id"]); ?>"></span>
                                                    <span class="pe-7s-close-circle" id="rehe-delete" attr-id="<?php echo ($teacher["tea_id"]); ?>" attr-message="删除"></span>
                                                </td>
...
<script>
    var SCOPE = {
        'skip_url' : 'admin.php?c=admin&a=add',
